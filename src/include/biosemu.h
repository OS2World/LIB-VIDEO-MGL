...
typedef struct {
	ulong	dwSize;
	ibool	(PMAPIP BE_init)(ibool shared,u32 debugFlags,int memSize,BE_VGAInfo *info);
...
{secret}
****************************************************************************/
typedef BE_exports * (PMAPIP BE_initLibrary_t)(ibool shared,PM_imports *PMImp);
...
ibool	PMAPI BE_init(ibool shared,u32 debugFlags,int memSize,BE_VGAInfo *info);
