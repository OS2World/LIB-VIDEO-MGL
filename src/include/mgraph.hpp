...
public:
	...
	inline	void	setSrcBlendFunc(int blendFunc)	{ MGL_setSrcBlendFunc(blendFunc); };
	inline	int 	getSrcBlendFunc() 				{ return MGL_getSrcBlendFunc(); };
	inline	void	setDstBlendFunc(int blendFunc) 	{ MGL_setDstBlendFunc(blendFunc); };
	inline	int		getDstBlendFunc() 				{ return MGL_getDstBlendFunc(); };
