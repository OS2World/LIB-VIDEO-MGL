...
#include "pmapi.h"
#define	PNGAPI	_ASMAPI
#define	PNGAPIP	_ASMAPIP

/* allow for compilation into a binary portable DLL and use in a DLL */
...
/* Don't compile any default error handling into the library (we expect it
 * to be overriden in our libraries).
 */

#ifndef	PNG_USE_DEFAULT_ERROR_HANDLER
#define	NO_DEFAULT_ERROR_HANDLER
#endif
