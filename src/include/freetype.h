...
#define TT_Flow_Error  0  /* an error occurred during rendering    */
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Set_Raster_Gray_Palette( TT_Engine  engine,
                                        TT_Byte*   palette );
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Open_Face( TT_Engine       engine,
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Open_Collection( TT_Engine       engine,
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Get_Face_Properties( TT_Face              face,
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Set_Face_Pointer( TT_Face  face,
                                 void*    data );
  ...
  EXPORT_DEF
  void* PMAPI     TT_Get_Face_Pointer( TT_Face  face );
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Flush_Face( TT_Face  face );
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Get_Face_Metrics( TT_Face     face,
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Close_Face( TT_Face  face );


  /* Get font or table data. */

  EXPORT_DEF
  TT_Error PMAPI  TT_Get_Font_Data( TT_Face   face,
                              TT_ULong  tag,
                              TT_Long   offset,
                              void*     buffer,
                              TT_Long*  length );
...
#define MAKE_TT_TAG( _x1, _x2, _x3, _x4 ) \
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_New_Instance( TT_Face       face,
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Set_Instance_Resolutions( TT_Instance  instance,
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Set_Instance_CharSize( TT_Instance  instance,
                                      TT_F26Dot6   charSize );

  EXPORT_DEF
  TT_Error PMAPI  TT_Set_Instance_CharSizes( TT_Instance  instance,
...
#define TT_Set_Instance_PointSize( ins, ptsize )   \
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Set_Instance_PixelSizes( TT_Instance  instance,
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Set_Instance_Transform_Flags( TT_Instance  instance,
                                             TT_Bool      rotated,
                                             TT_Bool      stretched );
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Get_Instance_Metrics( TT_Instance           instance,
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Set_Instance_Pointer( TT_Instance  instance,
                                     void*        data );
  ...
  EXPORT_DEF
  void* PMAPI     TT_Get_Instance_Pointer( TT_Instance  instance );


  /* Close a given instance object, destroying all associated data. */

  EXPORT_DEF
  TT_Error PMAPI  TT_Done_Instance( TT_Instance  instance );
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_New_Glyph( TT_Face    face,
                          TT_Glyph*  glyph );
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Done_Glyph( TT_Glyph  glyph );
...
#define TTLOAD_DEFAULT  (TTLOAD_SCALE_GLYPH | TTLOAD_HINT_GLYPH)
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Load_Glyph( TT_Instance  instance,
                           TT_Glyph     glyph,
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Get_Glyph_Outline( TT_Glyph     glyph,
                                  TT_Outline*  outline );
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Get_Glyph_Metrics( TT_Glyph           glyph,
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Get_Glyph_Big_Metrics( TT_Glyph               glyph,
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Get_Glyph_Bitmap( TT_Glyph        glyph,
                                 TT_Raster_Map*  map,
                                 TT_F26Dot6      xOffset,
                                 TT_F26Dot6      yOffset );
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Get_Glyph_Pixmap( TT_Glyph        glyph,
                                 TT_Raster_Map*  map,
                                 TT_F26Dot6      xOffset,
                                 TT_F26Dot6      yOffset );
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_New_Outline( TT_UShort    numPoints,
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Done_Outline( TT_Outline*  outline );


  /* Copy an outline into another one. */

  EXPORT_DEF
  TT_Error PMAPI  TT_Copy_Outline( TT_Outline*  source,
                             TT_Outline*  target );
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Get_Outline_Bitmap( TT_Engine       engine,
                                   TT_Outline*     outline,
                                   TT_Raster_Map*  map );
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Get_Outline_Pixmap( TT_Engine       engine,
                                   TT_Outline*     outline,
                                   TT_Raster_Map*  map );
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Get_Outline_BBox( TT_Outline*  outline,
                                 TT_BBox*     bbox );
  ...
  EXPORT_DEF
  void PMAPI TT_Transform_Outline( TT_Outline*  outline,
                                  TT_Matrix*   matrix );
  ...
  EXPORT_DEF
  void PMAPI TT_Translate_Outline( TT_Outline*  outline,
                                  TT_F26Dot6   xOffset,
                                  TT_F26Dot6   yOffset );
  ...
  EXPORT_DEF
  void PMAPI TT_Transform_Vector( TT_F26Dot6*  x,
                                 TT_F26Dot6*  y,
                                 TT_Matrix*   matrix );
  ...
  EXPORT_DEF
  TT_Long PMAPI TT_MulDiv( TT_Long A, TT_Long B, TT_Long C );
  ...
  EXPORT_DEF
  TT_Long PMAPI TT_MulFix( TT_Long A, TT_Long B );
  ...
  EXPORT_DEF
  int PMAPI TT_Get_CharMap_Count( TT_Face  face );
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Get_CharMap_ID( TT_Face     face,
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Get_CharMap( TT_Face      face,
                            TT_UShort    charmapIndex,
                            TT_CharMap*  charMap );
  ...
  EXPORT_DEF
  TT_UShort PMAPI TT_Char_Index( TT_CharMap  charMap,
                            TT_UShort   charCode );
  ...
  EXPORT_DEF
  int PMAPI TT_Get_Name_Count( TT_Face  face );
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Get_Name_ID( TT_Face     face,
                            TT_UShort   nameIndex,
                            TT_UShort*  platformID,
                            TT_UShort*  encodingID,
  ...
  EXPORT_DEF
  TT_Error PMAPI  TT_Get_Name_String( TT_Face      face,
                                TT_UShort    nameIndex,
  ...
  /* --------------------- exports table fpr BPD's ------------------- */

typedef struct {
	ulong		dwSize;
	TT_Error	(PMAPIP TT_Init_FreeType)(TT_Engine* engine);
	TT_Error 	(PMAPIP TT_Done_FreeType)(TT_Engine engine);
	TT_Error 	(PMAPIP TT_Set_Raster_Gray_Palette)(TT_Engine engine,TT_Byte* palette);
	TT_Error 	(PMAPIP TT_Open_Face)(TT_Engine engine,const TT_Text* fontPathName,TT_Face* face);
	TT_Error 	(PMAPIP TT_Open_Collection)(TT_Engine engine,const TT_Text* collectionPathName,TT_ULong fontIndex,TT_Face* face);
	TT_Error 	(PMAPIP TT_Get_Face_Properties)(TT_Face  face,TT_Face_Properties* properties);
	TT_Error 	(PMAPIP TT_Set_Face_Pointer)(TT_Face face,void* data);
	void* 		(PMAPIP TT_Get_Face_Pointer)(TT_Face face);
	TT_Error 	(PMAPIP TT_Flush_Face)(TT_Face face);
	TT_Error 	(PMAPIP TT_Get_Face_Metrics)(TT_Face face,TT_UShort firstGlyph,TT_UShort lastGlyph,TT_Short* leftBearings,TT_UShort* widths,TT_Short* topBearings,TT_UShort* heights);
	TT_Error 	(PMAPIP TT_Close_Face)(TT_Face face);
	TT_Error 	(PMAPIP TT_Get_Font_Data)(TT_Face face,TT_ULong tag,TT_Long offset,void* buffer,TT_Long* length);
	TT_Error 	(PMAPIP TT_New_Instance)(TT_Face face,TT_Instance* instance);
	TT_Error 	(PMAPIP TT_Set_Instance_Resolutions)(TT_Instance instance,TT_UShort xResolution,TT_UShort yResolution);
	TT_Error 	(PMAPIP TT_Set_Instance_CharSize)(TT_Instance instance,TT_F26Dot6 charSize);
	TT_Error 	(PMAPIP TT_Set_Instance_CharSizes)(TT_Instance instance,TT_F26Dot6 charWidth,TT_F26Dot6 charHeight);
	TT_Error 	(PMAPIP TT_Set_Instance_PixelSizes)(TT_Instance instance,TT_UShort pixelWidth,TT_UShort pixelHeight,TT_F26Dot6 pointSize);
	TT_Error 	(PMAPIP TT_Set_Instance_Transform_Flags)(TT_Instance instance,TT_Bool rotated,TT_Bool stretched);
	TT_Error 	(PMAPIP TT_Get_Instance_Metrics)(TT_Instance  instance,TT_Instance_Metrics* metrics);
	TT_Error 	(PMAPIP TT_Set_Instance_Pointer)(TT_Instance instance,void* data);
	void* 		(PMAPIP TT_Get_Instance_Pointer)(TT_Instance instance);
	TT_Error 	(PMAPIP TT_Done_Instance)(TT_Instance instance);
	TT_Error 	(PMAPIP TT_New_Glyph)(TT_Face face,TT_Glyph* glyph);
	TT_Error 	(PMAPIP TT_Done_Glyph)(TT_Glyph glyph);
	TT_Error 	(PMAPIP TT_Load_Glyph)(TT_Instance instance,TT_Glyph glyph,TT_UShort glyphIndex,TT_UShort loadFlags);
	TT_Error 	(PMAPIP TT_Get_Glyph_Outline)(TT_Glyph glyph,TT_Outline* outline);
	TT_Error 	(PMAPIP TT_Get_Glyph_Metrics)(TT_Glyph  glyph,TT_Glyph_Metrics* metrics);
	TT_Error 	(PMAPIP TT_Get_Glyph_Big_Metrics)(TT_Glyph  glyph,TT_Big_Glyph_Metrics* metrics);
	TT_Error 	(PMAPIP TT_Get_Glyph_Bitmap)(TT_Glyph glyph,TT_Raster_Map* map,TT_F26Dot6 xOffset,TT_F26Dot6 yOffset);
	TT_Error 	(PMAPIP TT_Get_Glyph_Pixmap)(TT_Glyph glyph,TT_Raster_Map* map,TT_F26Dot6 xOffset,TT_F26Dot6 yOffset);
	TT_Error 	(PMAPIP TT_New_Outline)(TT_UShort numPoints,TT_Short numContours,TT_Outline* outline);
	TT_Error 	(PMAPIP TT_Done_Outline)(TT_Outline* outline);
	TT_Error 	(PMAPIP TT_Copy_Outline)(TT_Outline* source,TT_Outline* target);
	TT_Error 	(PMAPIP TT_Get_Outline_Bitmap)(TT_Engine engine,TT_Outline* outline,TT_Raster_Map* map);
	TT_Error 	(PMAPIP TT_Get_Outline_Pixmap)(TT_Engine engine,TT_Outline* outline,TT_Raster_Map* map);
	TT_Error 	(PMAPIP TT_Get_Outline_BBox)(TT_Outline* outline,TT_BBox* bbox);
	void 		(PMAPIP TT_Transform_Outline)(TT_Outline* outline,TT_Matrix* matrix);
	void 		(PMAPIP TT_Translate_Outline)(TT_Outline* outline,TT_F26Dot6 xOffset,TT_F26Dot6 yOffset);
	void 		(PMAPIP TT_Transform_Vector)(TT_F26Dot6* x,TT_F26Dot6* y,TT_Matrix* matrix);
	TT_Long 	(PMAPIP TT_MulDiv)(TT_Long A,TT_Long B,TT_Long C);
	TT_Long 	(PMAPIP TT_MulFix)(TT_Long A,TT_Long B);
	int 		(PMAPIP TT_Get_CharMap_Count)(TT_Face face);
	TT_Error 	(PMAPIP TT_Get_CharMap_ID)(TT_Face face,TT_UShort charmapIndex,TT_UShort* platformID,TT_UShort* encodingID);
	TT_Error 	(PMAPIP TT_Get_CharMap)(TT_Face face,TT_UShort charmapIndex,TT_CharMap* charMap);
	TT_UShort 	(PMAPIP TT_Char_Index)(TT_CharMap charMap,TT_UShort charCode);
	int 		(PMAPIP TT_Get_Name_Count)(TT_Face face);
	TT_Error 	(PMAPIP TT_Get_Name_ID)(TT_Face face,TT_UShort nameIndex,TT_UShort* platformID,TT_UShort* encodingID,TT_UShort* languageID,TT_UShort* nameID);
	TT_Error 	(PMAPIP TT_Get_Name_String)(TT_Face face,TT_UShort nameIndex,TT_String** stringPtr,TT_UShort* length);
	} TT_exports;

typedef TT_exports * (PMAPIP TT_initLibrary_t)(void);
