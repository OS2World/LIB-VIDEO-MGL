...
#endif
extern int		_PM_deskX,_PM_deskY;	/* Desktop dimentions			*/
extern HWND		_PM_hwndConsole;		/* Window handle for console	*/
extern HWND		_PM_hwndUser;			/* User window handle			*/
extern ibool	_PM_haveWinNT;			/* True if we are running on NT	*/
extern HINSTANCE		_PM_hInstDD;	/* Handle to DirectDraw DLL 	*/
extern LPDIRECTDRAW		_PM_lpDD1;		/* DirectDraw object			*/
extern LPDIRECTDRAW2	_PM_lpDD;		/* DirectDraw2 object			*/
