...
void _EVT_pumpMessages(void)
{
	...
	while (PeekMessage(&msg,NULL,0,0,PM_REMOVE)) {
		...
		// TODO: Add support for DirectInput!
	...
	_EVT_mouseMoveHandler mouseMove)
{
	...
	/* Now load DirectDraw since we need this */
/*	if (!_PM_loadDirectDraw())
		PM_fatalError("Unable to load DirectDraw!");*/
