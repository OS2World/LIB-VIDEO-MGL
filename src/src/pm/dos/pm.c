...
static uint		VXD_off = 0;
static uint		VXD_sel = 0;
...
void PMAPI PM_VxDCall(
	VXD_regs *regs)
{
	if (VXD_sel != 0 || VXD_off != 0)
		_PM_VxDCall(regs,VXD_off,VXD_sel);
}
