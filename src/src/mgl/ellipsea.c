...
static void        	(MGLAPIP putPixel)(long x,long y);
	...
	int endAngle)
{
	...
	if (DC.a.clipRegion) {
		...
		__MGL_fillEllipseArc(extentRect.left + DC.a.viewPort.left,
			extentRect.top + DC.a.viewPort.top,A,B,
