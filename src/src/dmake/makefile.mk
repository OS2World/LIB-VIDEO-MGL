...
scripts: unix-scripts\
	 ...
	 msdos-scripts win95-scripts winnt-scripts os2-scripts;
...
unix-freebsd-gnu-scripts-flags = OS=unix OSRELEASE=freebsd OSENVIRONMENT=gnu
...
unix-scripts .SWAP : clean
	...
	$(MAKE) SCRIPTFILE=make.sh unix-freebsd-gnu-scripts
