...
del dirbrk.obj
bcc32 -c -I. -Iwinnt -Iwinnt\borland -d -O -N- -w-nod -A- -w-pro -Iwinnt\borland\bcc50  win95\switchar.c
...
del ruletab.obj
bcc32 -c -I. -Iwinnt -Iwinnt\borland -d -O -N- -w-nod -A- -w-pro -Iwinnt\borland\bcc50  msdos\runargv.c
copy runargv.obj objects
del runargv.obj
bcc32 -c -I. -Iwinnt -Iwinnt\borland -d -O -N- -w-nod -A- -w-pro -Iwinnt\borland\bcc50  msdos\rmprq.c
copy rmprq.obj objects
del rmprq.obj
tlink32  @winnt\borland\bcc50\obj.rsp,dmake.exe,NUL.MAP,@winnt\borland\bcc50\lib.rsp
