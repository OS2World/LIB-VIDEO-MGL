/* RCS      -- $Header: /n/Source/Cvs/wti/dmake/source/winnt/microsft/vpp40/public.h,v 1.1.1.1.2.1 1997/08/24 07:39:16 dvadura Exp $
...
-- LOG
--      $Log: public.h,v $
--      Revision 1.1.1.1.2.1  1997/08/24 07:39:16  dvadura
--      Fixed winnt microsoft build problems, OS/2 build issue, and an issue with
--      the microsoft version tempnam.c not generating unique temp file names under
--      Windows-NT.
--
*/
