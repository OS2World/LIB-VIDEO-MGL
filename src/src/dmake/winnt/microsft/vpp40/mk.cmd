...
cl -c -I. -Iwinnt -Iwinnt\microsft -Iwinnt\microsft\vpp40 /nologo -Od -GF -Ge -Foobjects\switchar.obj win95\switchar.c
...
link /nologo /out:dmake.exe @winnt\microsft\vpp40\obj.rsp 
