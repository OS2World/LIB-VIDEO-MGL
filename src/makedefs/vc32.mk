...
.IMPORT .IGNORE : TNT_PATH VC_LIBBASE DOSSTYLE USE_TNT USE_RTTARGET
...
.IF $(USE_WIN32)
   LDFLAGS       = $(CFLAGS)
.IF $(WIN32_GUI)
   LDENDFLAGS   = -link /INCREMENTAL:NO /DEF:$(@:b).def /SUBSYSTEM:WINDOWS /MACHINE:I386 /PDB:NONE /DEBUGTYPE:COFF
.ELSE
   LDENDFLAGS   = -link /INCREMENTAL:NO /SUBSYSTEM:CONSOLE /MACHINE:I386 /PDB:NONE /DEBUGTYPE:COFF
.ENDIF
.ELSE
   LDFLAGS       = $(CFLAGS)
...
.IF $(NO_RUNTIME)
   ...
   DEF_LIBS		:=
.ELSE
   DEF_LIBS		:= kernel32.lib user32.lib gdi32.lib advapi32.lib shell32.lib winmm.lib comdlg32.lib comctl32.lib ole32.lib version.lib
.ENDIF
.ELSE
   CFLAGS       += /MT
   DEF_LIBS		:= kernel32.lib user32.lib gdi32.lib advapi32.lib shell32.lib winmm.lib comdlg32.lib comctl32.lib ole32.lib version.lib
