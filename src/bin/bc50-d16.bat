...
%SCITECH%\bin-dos\k_cp %SCITECH%\BIN\release\tlink5.dos %BC5_PATH%\BIN\tlink.cfg
%SCITECH%\bin-dos\k_cp %SCITECH%\BIN\release\turboc5.dos %BC5_PATH%\BIN\turboc.cfg
echo Release build enabled.
goto setvars

:checked_build
SET LIB=%SCITECH_LIB%\LIB\DEBUG\DOS16\BC5;%BC5_PATH%\LIB;.
%SCITECH%\bin-dos\k_cp %SCITECH%\BIN\debug\tlink5.dos %BC5_PATH%\BIN\tlink.cfg
%SCITECH%\bin-dos\k_cp %SCITECH%\BIN\debug\turboc5.dos %BC5_PATH%\BIN\turboc.cfg
