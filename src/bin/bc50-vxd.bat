...
%SCITECH%\bin-dos\k_cp %SCITECH%\BIN\release\tlink52.vxd %BC5_PATH%\BIN\tlink32.cfg
%SCITECH%\bin-dos\k_cp %SCITECH%\BIN\release\bcc52.vxd %BC5_PATH%\BIN\bcc32.cfg
echo Release build enabled.
goto setvars

:checked_build
SET LIB=%SCITECH_LIB%\LIB\DEBUG\VXD\BC5;%BC5_PATH%\LIB;.
%SCITECH%\bin-dos\k_cp %SCITECH%\BIN\debug\tlink52.vxd %BC5_PATH%\BIN\tlink32.cfg
%SCITECH%\bin-dos\k_cp %SCITECH%\BIN\debug\bcc52.vxd %BC5_PATH%\BIN\bcc32.cfg
