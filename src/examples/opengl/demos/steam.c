/**
  ...
  Notes:       - Transparence doesn't quite work. The color of the
			   ...
			   - Also only the front side of the transparent objects are
				 transparent.
  Additions:   - Modified for stereoscopic displays implementing
				 GL_STEREO compatible quad-buffering. (Dave Milici)
**/
...
/* Global def for stereo3d code additions. */
#define STEREO
