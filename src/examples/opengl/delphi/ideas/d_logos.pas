...
procedure   draw_single_cylinder;
begin
...
procedure   draw_double_cylinder;
begin
    glBegin(GL_TRIANGLE_STRIP);
    glVertex3fv(@dcp[0]);
    glVertex3fv(@dcp[1]);
