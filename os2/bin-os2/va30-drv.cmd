...
SET LIB=%SCITECH_LIB%\lib\release\os232\va3;%VA3_PATH%\LIB;%VA3_PATH%\DLL
...
:setvars
SET INCLUDE=include;%SCITECH%\include;%PRIVATE%\include;%VA3_PATH%\INCLUDE;%VA3_PATH%\INCLUDE\OS2;%VA3_PATH%\INC;%VA3_PATH%\INCLUDE\SOM
...
set HOST_PROC=386
set HOST_OS=os2
PATH c:\ddk\tools;c:\ddk\masm60\binp;%SCITECH%\bin-os2;%VA3_PATH%\BIN;%VA3_PATH%\HELP;%VA3_PATH%\SMARTS\SCRIPTS;%DEFPATH%%VA_CD_PATH%
